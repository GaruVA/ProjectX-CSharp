...
namespace ProjectX {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class BookingsDataTable : global::System.Data.TypedTableBase<BookingsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BookingsRow AddBookingsRow(int BookingID, int ItineraryID, int CustomerID, System.DateTime StartDate, System.DateTime EndDate, decimal TotalCost, string PaymentMethod, string Status, System.DateTime BookingDate) {
        ...
        public partial class BookingsRow : global::System.Data.DataRow {
            ...
            public int ItineraryID {
                get {
                    return ((int)(this[this.tableBookings.ItineraryIDColumn]));
                }
                set {
                    this[this.tableBookings.ItineraryIDColumn] = value;
                }
            }
...
namespace ProjectX.DatabaseDataSetTableAdapters {
    ...
    public partial class BookingsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Bookings] WHERE (([BookingID] = @Original_BookingID) AND ([ItineraryID] = @Original_ItineraryID) AND ([CustomerID] = @Original_CustomerID) AND ([StartDate] = @Original_StartDate) AND ([EndDate] = @Original_EndDate) AND ([TotalCost] = @Original_TotalCost) AND ([PaymentMethod] = @Original_PaymentMethod) AND ([Status] = @Original_Status) AND ([BookingDate] = @Original_BookingDate))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_TotalCost", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 9, 2, "TotalCost", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Bookings] ([BookingID], [ItineraryID], [CustomerID], [StartDate], [EndDate], [TotalCost], [PaymentMethod], [Status], [BookingDate]) VALUES (@BookingID, @ItineraryID, @CustomerID, @StartDate, @EndDate, @TotalCost, @PaymentMethod, @Status, @BookingDate);
SELECT BookingID, ItineraryID, CustomerID, StartDate, EndDate, TotalCost, PaymentMethod, Status, BookingDate FROM Bookings WHERE (BookingID = @BookingID)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ItineraryID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ItineraryID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@TotalCost", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 9, 2, "TotalCost", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Bookings] SET [BookingID] = @BookingID, [ItineraryID] = @ItineraryID, [CustomerID] = @CustomerID, [StartDate] = @StartDate, [EndDate] = @EndDate, [TotalCost] = @TotalCost, [PaymentMethod] = @PaymentMethod, [Status] = @Status, [BookingDate] = @BookingDate WHERE (([BookingID] = @Original_BookingID) AND ([ItineraryID] = @Original_ItineraryID) AND ([CustomerID] = @Original_CustomerID) AND ([StartDate] = @Original_StartDate) AND ([EndDate] = @Original_EndDate) AND ([TotalCost] = @Original_TotalCost) AND ([PaymentMethod] = @Original_PaymentMethod) AND ([Status] = @Original_Status) AND ([BookingDate] = @Original_BookingDate));
SELECT BookingID, ItineraryID, CustomerID, StartDate, EndDate, TotalCost, PaymentMethod, Status, BookingDate FROM Bookings WHERE (BookingID = @BookingID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ItineraryID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ItineraryID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@TotalCost", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 9, 2, "TotalCost", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_TotalCost", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 9, 2, "TotalCost", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ProjectX.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT BookingID, ItineraryID, CustomerID, StartDate, EndDate, TotalCost, Payment" +
                "Method, Status, BookingDate FROM dbo.Bookings";
        ...
        public virtual int Delete(int Original_BookingID, int Original_ItineraryID, int Original_CustomerID, System.DateTime Original_StartDate, System.DateTime Original_EndDate, decimal Original_TotalCost, string Original_PaymentMethod, string Original_Status, System.DateTime Original_BookingDate) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_BookingID));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_ItineraryID));
            ...
            this.Adapter.DeleteCommand.Parameters[8].Value = ((System.DateTime)(Original_BookingDate));
        ...
        public virtual int Insert(int BookingID, int ItineraryID, int CustomerID, System.DateTime StartDate, System.DateTime EndDate, decimal TotalCost, string PaymentMethod, string Status, System.DateTime BookingDate) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(BookingID));
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(ItineraryID));
            ...
            this.Adapter.InsertCommand.Parameters[8].Value = ((System.DateTime)(BookingDate));
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(ItineraryID));
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((System.DateTime)(BookingDate));
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_BookingID));
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_ItineraryID));
        ...
        public virtual int Update(
                    ...
                    string Original_Status, 
                    System.DateTime Original_BookingDate) {
            return this.Update(Original_BookingID, ItineraryID, CustomerID, StartDate, EndDate, TotalCost, PaymentMethod, Status, BookingDate, Original_BookingID, Original_ItineraryID, Original_CustomerID, Original_StartDate, Original_EndDate, Original_TotalCost, Original_PaymentMethod, Original_Status, Original_BookingDate);
        }
    }
